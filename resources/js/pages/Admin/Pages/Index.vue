...
const selectedIds = computed(() =>
    Object.keys(rowSelection.value).map(idx => props.pages[Number(idx)]?.id).filter(Boolean)
);
...
<template>
    ...
    <div class="container mx-auto mt-6">
        ...
        <BulkActionBar
            ...
            model-name="page"
            :bulk-approve-route="route('admin.pages.bulk-approve')"
            :bulk-publish-route="route('admin.pages.bulk-publish')"
            :bulk-delete-route="route('admin.pages.bulk-delete')"
