...
'filesystems.links./var/www/html/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','concurrency.default','telescope.enabled',
...
'command','index','rules.index','rules.page.view','rules.index.view',
'rules.section.view','admin.users.index','admin.users.create','admin.users.edit','admin.users.store',
'admin.users.update','admin.users.delete','admin.roles.index','admin.roles.create','admin.roles.edit',
'admin.roles.store','admin.roles.update','admin.roles.delete','admin.batches.index','admin.batches.create',
'admin.batches.preview','admin.batches.edit','admin.batches.store','admin.batches.update','admin.batches.delete',
'admin.batches.publish','admin.indices.index','admin.indices.view','admin.indices.preview','admin.indices.create',
'admin.indices.list','admin.indices.edit','admin.indices.store','admin.indices.update','admin.indices.delete',
'admin.indices.publish','admin.sections.index','admin.sections.view','admin.sections.preview','admin.sections.list',
'admin.sections.create','admin.sections.edit','admin.sections.store','admin.sections.update','admin.sections.delete',
'admin.sections.publish','admin.pages.index','admin.pages.view','admin.pages.preview','admin.pages.list',
'admin.pages.create','admin.pages.edit','admin.pages.store','admin.pages.update','admin.pages.delete',
'admin.pages.publish','admin.pages.order.index','admin.pages.order.update','admin.approvals.index','admin.approvals.edit',
'admin.approvals.update','profile.edit','profile.update','profile.destroy',
