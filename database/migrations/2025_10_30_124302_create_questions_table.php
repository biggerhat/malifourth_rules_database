...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('questions', function (Blueprint $table) {
            ...
            $table->foreignId('previous')->nullable()->constrained('questions', 'id');
            $table->foreignId('original')->nullable()->constrained('questions', 'id');
            $table->foreignId('newest')->nullable()->index()->constrained('questions', 'id');
